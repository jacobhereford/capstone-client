...
/***/ function(module, exports, __webpack_require__) {
	...
	var contactEvents = __webpack_require__(33);
	var appointmentEvents = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var appointmentTemplate = __webpack_require__(28);

	// const modal = require('../../templates/modal.handlebars');
	var contactApi = __webpack_require__(29);
	var appointmentApi = __webpack_require__(30);
	var contactUi = __webpack_require__(31);
	var appointmentUi = __webpack_require__(32);
	...
	var getContactsOnSignIn = function getContactsOnSignIn() {
	  ...
	  appointmentApi.getAppointment().done(function (data) {
	...
	module.exports = {
	  ...
	  getContactsOnSignIn: getContactsOnSignIn
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <tr>\n        <th scope=\"row\"></th>\n        <td>"
	    ...
	    + "</td>\n        <td>"
	    + alias4(((helper = (helper = helpers.works_at || (depth0 != null ? depth0.works_at : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"works_at","hash":{},"data":data}) : helper)))
	    + "</td>\n        <td><button class=\"btn btn-default update-contact\" type=\"submit\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Update Contact</button></td>\n        <td><button class=\"btn btn-default delete-contact\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Delete Contact</button></td>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, buffer = 
	  "<table class=\"table table-striped\">\n  <thead>\n    <tr>\n      <th></th>\n      <th>Name</th>\n      <th>E-mail</th>\n      <th>Phone Number</th>\n      <th>Works At</th>\n      <th>Update</th>\n      <th>Delete</th>\n    </tr>\n  </thead>\n  <tbody>\n";
	  stack1 = ((helper = (helper = helpers.contacts || (depth0 != null ? depth0.contacts : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"contacts","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <tr>\n        <th scope=\"row\"></th>\n        <td>"
	    + alias4(((helper = (helper = helpers.what || (depth0 != null ? depth0.what : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"what","hash":{},"data":data}) : helper)))
	    + "</td>\n        <td>"
	    ...
	    + "</td>\n        <td><button class=\"btn btn-default update-appointment\" type=\"submit\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Update appointment</button></td>\n        <td><button class=\"btn btn-default delete-appointment\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Delete appointment</button></td>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, buffer = 
	  "<table class=\"table table-striped\">\n  <thead>\n    <tr>\n      <th></th>\n      <th>What</th>\n      <th>When</th>\n      <th>Where</th>\n      <th>Update</th>\n      <th>Delete</th>\n    </tr>\n  </thead>\n  <tbody>\n";
	  stack1 = ((helper = (helper = helpers.appointments || (depth0 != null ? depth0.appointments : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"appointments","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.appointments) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer + "  </tbody>\n</table>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deleteContact = function deleteContact(contact_id) {
	  return $.ajax({
	...
	var updateContact = function updateContact(data, contact_id) {
	  return $.ajax({
	    url: app.host + '/contacts/' + contact_id,
	    method: "PATCH",
	    headers: {
	...
	var getContacts = function getContacts(contact_id) {
	  return $.ajax({
	    url: app.host + '/contacts/' + contact_id,
	    method: "GET",
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAppointment = function getAppointment() {
	  return $.ajax({
	    url: app.host + '/appointments',
	    method: "GET",
	    headers: {
	...
	var getAppointments = function getAppointments(appointment_id) {
	  return $.ajax({
	    url: app.host + '/appointments/' + appointment_id,
	    method: "GET",
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getContacts = function getContacts() {
	  api.getContacts().done(displayContacts).fail(failure);
	};

	var deleteContact = function deleteContact(event) {
	  event.preventDefault();
	  var contact_id = $(event.target).attr('data-id');
	  api.deleteContact(contact_id).done(removeFromTable(event)).fail(failure);
	};

	var updateContact = function updateContact(data, contact_id) {
	  api.updateContact(data, contact_id).done(getContacts).fail();
	};

	var removeFromTable = function removeFromTable(e) {
	  $(e.target).parents('tr').remove();
	};

	var displayContacts = function displayContacts(data) {
	  var contacts = data;
	...
	var createContactSuccess = function createContactSuccess() {
	  $('#contacts-table').html('');
	  api.getContact().done(displayContacts).fail(failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAppointments = function getAppointments() {
	  api.getAppointments().done(displayAppointments).fail(failure);
	};
	...
	var displayAppointments = function displayAppointments(data) {
	...
	var createAppointmentSuccess = function createAppointmentSuccess() {
	  $('#appointments-table').html('');
	  api.getAppointment().done(displayAppointments).fail(failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateContact = function updateContact(event) {
	  event.preventDefault();
	  ...
	  if ($('#update-1').val() === '' || $('#update-2').val() === '' || $('#update-3').val() === '' || $('#update-4').val() === '') {
	    ...
	    api.updateContact(data, contact_id).done(ui.createContactSuccess).fail(ui.failure);
	  }
	};

	var createContact = function createContact(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if ($('#create-1').val() === '' || $('#create-2').val() === '' || $('#create-3').val() === '' || $('#create-4').val() === '') {
	    ...
	    api.createContact(data).done(ui.createContactSuccess).fail(ui.failure);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateAppointment = function updateAppointment(event) {
	  event.preventDefault();
	  ...
	  if ($('#update-5').val() === '' || $('#update-6').val() === '' || $('#update-7').val() === '') {
	    ...
	    api.updateAppointment(data, appointment_id).done(ui.createAppointmentSuccess).fail(ui.failure);
	  }
	};

	var createAppointment = function createAppointment(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  if ($('#create-5').val() === '' || $('#create-5').val() === '' || $('#create-7').val() === '') {
	    ...
	    api.createAppointment(data).done(ui.createAppointmentSuccess).fail(ui.failure);
	  }
	};
